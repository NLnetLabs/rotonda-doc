...
Tailored Performance
   ...
   Rotonda is no exception. Rotonda aims to offer units that perform the
   ...
   small installation in a constraint environment.
...
Robustness & Scalability
   ...
   an AVRO-based protocol, that we dubbed ``rotoro``.
